...
class SearchedMoviePagingSource(var key: String,var query:String, var repository: MovieListRepository) : PagingSource<Int, MovieModel>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, MovieModel> {
        ...
        return try {
            val response = repository.getSearchedMovies( key , query, page.toString()).body()!!.movies
            LoadResult.Page(
